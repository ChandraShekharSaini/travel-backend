      ...
      const destinations = [
        {
          title: "Kashmir",
          description:
            "Experience the breathtaking views of the Himalayas, houseboats, and rich culture.",
        ...
        },
        {
          title: "Manali",
          description:
            "Let's shoot YJHD-2! Pack your bags and explore this trending destination.",
          imgSrc: "/images/manali.jpg",
        },
        {
          title: "Vrindavan",
          description:
            "The place where you learn PREM RAS and experience divine love.",
